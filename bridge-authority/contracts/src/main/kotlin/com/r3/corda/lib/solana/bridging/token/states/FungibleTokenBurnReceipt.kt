 ...
 *
 * @property redemptionTokenAccount Token account public key (base58 string) on Solana from which
 * the tokens were burnt.
 * @property redemptionWalletAccount Token wallet public key (base58 string) on Solana that owns
